...
RUN apt-get update \
 ...
 && curl -Lo vault.zip https://releases.hashicorp.com/vault/1.5.3/vault_1.5.3_linux_amd64.zip \
     ...
     && rm vault.zip \
 && curl -Lo /usr/bin/safe https://github.com/starkandwayne/safe/releases/download/v1.5.9/safe-linux-amd64 \
     && chmod 0755 /usr/bin/safe \
 && curl -Lo /usr/bin/spruce https://github.com/geofffranks/spruce/releases/download/v1.27.0/spruce-linux-amd64 \
 ...
 && curl -Lo /usr/bin/bosh https://github.com/cloudfoundry/bosh-cli/releases/download/v6.4.1/bosh-cli-6.4.1-linux-amd64 \
